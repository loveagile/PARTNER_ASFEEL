...
export const TopFooter = () => {
  return (
    <div className="flex w-full flex-col gap-[10px] border border-gray-gray bg-gray-white px-[10px] py-4 text-mini  text-gray-gray_dark">
      <div className="flex flex-row items-start justify-center ">
        <a href={EXTERNAL_URLS.termsOfUse} target="_blank" className="flex flex-row items-center gap-[2px] px-[10px]">
          <TextSnippetIcon />
          <div>利用規約</div>
        </a>
        <div className="h-4 w-[1px] bg-gray-gray_dark"></div>
        <a
          href={EXTERNAL_URLS.privacyPolicy}
          target="_blank"
          className="flex flex-row items-center gap-[2px] px-[10px]"
        >
          <SecurityIcon />
          <div>プライバシーポリシー</div>
        </a>
