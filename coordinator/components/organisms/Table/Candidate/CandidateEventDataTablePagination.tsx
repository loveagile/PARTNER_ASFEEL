...
import { eventCandidatePaginationAtom } from "@/recoil/atom/events/eventCandidateAtom"
import { useRecoilState } from "recoil"

export interface CandidateEventDataTablePaginationProps {
...
const CandidateEventDataTablePagination = ({ currentPage, setCurrentPage, pageSize, numberOfCandidates }: CandidateEventDataTablePaginationProps) => {
  const [pageLength, setPageLength] = useState(0)
  const [pagination, setPagination] = useRecoilState(eventCandidatePaginationAtom);
...
export default CandidateEventDataTablePagination