...
interface CandidateScoutTableHeaderProps{
  currentSort: CandidateSort
  setCurrentSort: (sort: CandidateSort) => void
}

const CandidateScoutTableHeader = ({currentSort, setCurrentSort} :  CandidateScoutTableHeaderProps) =>{
...
export default CandidateScoutTableHeader