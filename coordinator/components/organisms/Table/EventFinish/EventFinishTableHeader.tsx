...
import {SortInterface} from './EventFinishTable'
...
const EventFinishTableHeader = ({currentSort, setCurrentSort} :  TableHeaderProps) =>{
...
export default EventFinishTableHeader