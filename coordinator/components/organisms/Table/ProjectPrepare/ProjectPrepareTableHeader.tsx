...
import {SortInterface} from './ProjectPrepareTable'
...
const ProjectPrepareTableHeader = ({currentSort, setCurrentSort} :  TableHeaderProps) =>{
  ...
  return(
    <thead className="">
      <tr className="border-b h-[55px] border-gray-gray_light text-timestamp text-gray-gray_dark">
        ...
        <th>
          <TableHeaderLabel  label='募集開始日' sortName="createdAt" currentSort={currentSort} onClick={handleClick} />
        </th>
      </tr>
    </thead>
  )
...
export default ProjectPrepareTableHeader