...
import {SortInterface} from './EventPrepareTable'
...
const EventPrepareTableHeader = ({currentSort, setCurrentSort} :  TableHeaderProps) =>{
...
export default EventPrepareTableHeader