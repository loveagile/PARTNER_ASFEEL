...
const FileIcon: React.FC<FileIconProps> = ({ extension }) => {
  ...
  switch (ext) {
    case 'PDF':
      return <Image src="/images/icons/pdf.svg" width={16} height={20} alt="" />
    case 'XLS':
      return (
    ...
    case 'PNG':
      return <Image src="/images/icons/png.svg" width={16} height={20} alt="" />
    case 'JPG':
      return <Image src="/images/icons/jpg.svg" width={16} height={20} alt="" />
    default:
