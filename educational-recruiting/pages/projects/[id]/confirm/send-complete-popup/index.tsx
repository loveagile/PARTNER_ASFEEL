    ...
    <div className="fixed left-1/2 top-1/2 h-screen w-full -translate-x-1/2 -translate-y-1/2 transform bg-gray-black_clear">
      ...
      <div className="absolute left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 transform">
        <div className="w-full flex justify-center">
          <div className="relative flex flex-col items-center gap-5 pc:p-10 rounded-[10px] isolate bg-gray-white sp:w-[280px] pc:w-[480px] sp:py-[30px] sp:px-5">
            ...
            <IoClose
              className="absolute w-[24px] h-[24px] top-[26.41px] right-[25.41px] hover:cursor-pointer"
              onClick={() => {
                Router.push('/')
              }}
            />
