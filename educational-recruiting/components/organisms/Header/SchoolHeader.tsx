...
export const SchoolHeader = () => {
  ...
  return view == 'PC' ? (
    <div className="h-[64px] flex flex-row items-center justify-between py-[10px] px-10 gap-[10px] bg-core-blue_dark text-gray-white">
      <HeaderLogo onClick={() => router.push('/')} />
      <div className="flex flex-row items-center gap-5 text-timestamp">
        <Link
          href={'https://asfeel.notion.site/_-3b43a44c2fc1472da083b4df3e58a133?pvs=4'}
        ...
        <Link
          href={'https://asfeel.notion.site/fa1cb09e7cc04bf7b6bc677701bcdf5b?pvs=4'}
          className="flex flex-row items-center gap-1 hover:cursor-pointer"
          target="_blank"
        >
          <MenuBookIcon />
        ...
        <Link
          href={'https://asfeel.notion.site/f0045762f6044eb4b382350cc9b56a34?pvs=4'}
          className="flex flex-row items-center gap-1 hover:cursor-pointer"
          target="_blank"
        >
          <SecurityIcon />
    ...
    <div className="h-[64px] flex flex-row items-center justify-between py-[10px] pc:px-10 sp:px-[10px] gap-[10px] bg-core-blue_dark text-gray-white">
      <HeaderLogo onClick={() => router.push('/')} />
      <div className="inset-y-0 left-0 flex items-center ">
        <button
          type="button"
          className="inline-flex items-center justify-center w-8 h-8 p-2 rounded-md text-gray-white hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
      ...
      {open && (
        <div className="absolute top-0 left-0 z-10 flex flex-col items-center w-full gap-4 py-4 mt-14 text-timestamp bg-core-blue_dark">
          <Link
            href={'https://asfeel.notion.site/_-3b43a44c2fc1472da083b4df3e58a133?pvs=4'}
            className="flex flex-row items-center gap-1 hover:cursor-pointer"
            target="_blank"
