...
export default function CoordinatorLayout({ children, setCurrentPage }: { children: React.ReactNode; setCurrentPage?: (href: string) => void }) {
  ...
  return (
    <>
      ...
      <div className="flex min-h-[calc(100vh-64px)]">
        <Sidebar groups={groups.groups} activeItem={activeItem} setActiveItem={setActiveItem} setCurrentPage={setCurrentPage} />
        {children}
      </div>
    </>
  )
